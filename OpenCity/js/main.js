(function($) {	
    ...
    if($('.main-header li.dropdown ul').length){
        $('.main-header .navigation li.dropdown').append('<div class="dropdown-btn"><i class="flaticon-down"></i></div>');
    }
	...
	if ($('.countdown').length) {
	    $('.countdown').countdown('2023/10/12', function (event) {
	        var $this = $(this).html(event.strftime('' + '<div class="counter-column"><div class="count">%D</div><span>Days</span></div> ' + '<div class="counter-column"><div class="count">%H</div><span>Hours</span></div>  ' + '<div class="counter-column"><div class="count">%M</div><span>Minutes</span></div>  ' + '<div class="counter-column"><div class="count">%S</div><span>Seconds</span></div>'));
	    });
	}
